\section{Vergleich verschiedener \textit{Machine Learning}-Algorithmen (Alex)}
...
In der Eingabeschicht werden die Bilddaten gespeichert und in einer dreidimensionlae Matrix dargestellt.\cite*{Sewak2018}
...
\begin{minipage}{\textwidth}
	\begin{lstlisting}[language=Python, caption=Pythoncode zur Konstuktion vom CNNs, label=lst:test_cnn]
#CNN
