\section{Vergleich verschiedener \textit{Machine Learning}-Algorithmen (Alex)} \label{sec:compare}
...
\subsection{KNN (Dirk)} \label{ssec:knn}

\newpage

\subsection{Support Vector Machine (Alex)} \label{ssec:svm}
